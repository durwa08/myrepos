...
attempts collection in MongoDB, scoped to the attempt lifecycle:
starting, resuming, saving answers, and submitting.
"""
...
async def submit_attempt(attempt_id: str, submission_data: dict) -> dict | None:
    """
    Finalize an attempt with its computed score.
